...
# --- CSS: 격자 틈새 제거 & 말 색상 고정 (Black Ink) ---
st.markdown("""
<style>
    /* 1. 배경 정리 */
    ...
    div.stButton > button {
        width: 100% !important;
        aspect-ratio: 1 / 1;
        font-size: 42px !important;    /* 말 크기 키움 */
        font-weight: 500 !important;   /* 적당한 두께 */
        padding: 0px !important;
        margin: 0px !important;
        ...
        /* [핵심 수정] 모든 글자(말) 색상을 '검은색'으로 고정 */
        /* 이렇게 해야 흑은 '꽉 찬 검정', 백은 '검정 테두리'로 나옵니다 */
        color: #000000 !important;
        -webkit-text-fill-color: #000000 !important;
    }

    /* 4. 체스판 배경색 (눈이 편한 우드 톤) */
    /* 어두운 칸 (Dark Square) */
    div.stButton > button[kind="primary"] {
        background-color: #D18B47 !important; /* 약간 밝은 갈색 (검은 글씨가 잘 보이도록) */
    }
    /* 밝은 칸 (Light Square) */
    div.stButton > button[kind="secondary"] {
        background-color: #FFCE9E !important; /* 연한 살구색/베이지 */
    }

    /* 5. 선택 효과 */
    div.stButton > button:focus {
        background-color: #f7e034 !important; /* 쨍한 노란색 */
...
# ================= UI =================
st.title("♟️ Classic Chess Board")
